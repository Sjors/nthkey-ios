...
class WalletComposerTests: XCTestCase {
    ...
    func testAnnounceOurKey() {
        let expected = #"""
        {"announcements":{"3442193e":{"can_decompile_miniscript":false,"name":"NthKey","sub_policy":"pk(3442193e)"}}}
        """#
    ...
    func testAnnounceOtherKeys() {
        let expected = #"""
        {"announcements":{"3442193e":{"can_decompile_miniscript":false,"name":"NthKey","sub_policy":"pk(3442193e)"},"bd16bee5":{"name":"","sub_policy":"pk(bd16bee5)"}}}
        """#
